...
class LoggerCard extends StatelessWidget {
  ...
  final Color? color;
  const LoggerCard({super.key, this.isHistoryView = false, this.color});
    ...
    return Container(
      ...
      child: Column(
        children: [
          Row(
            children: [
              Image.asset(AppAssets.kFoodImage1, height: 50.h, width: 50.w),
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        SizedBox(width: 10.w),
                        Text(' •  2 Dishes', style: AppTypography.kLight11),
                      ],
                    ),
                  ],
                ),
